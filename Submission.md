...
6. Used React Query as the http client, so that it more pages would done the performance would improve by caching and invalitading the queries to refetch only when the data is changed.
